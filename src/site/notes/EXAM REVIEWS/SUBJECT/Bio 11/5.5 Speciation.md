---
{"dg-publish":true,"permalink":"/EXAM REVIEWS/SUBJECT/Bio 11/5.5 Speciation/","created":"2026-05-19T06:23:54.172-04:00","updated":"2026-06-07T19:06:17.339-04:00","dg-note-properties":{}}
---
...
###### Species
- Groups of organisms that can exchange genes (or allow inbreeding) and give rise to offspring that can reproduce.
	- Species arise $\rightarrow$ species formation (speciation) $\rightarrow$ form of macroevolution
...
###### Habitat 
- Occurs when two species occupy different niches (roles/positions the organism has in a environment)
###### Behavioural
- Occurs when two species have different courtship (behaviour that leads to mating) behaviours
	- Mates of other species cannot respond to specific mating behaviours
###### Mechanical
- Occurs when physical differences prevent copulation or pollination
###### Gametic Isolation
...
- Large **geographical barriers** that can separate populations
	- $\neq$ can't procreate $\rightarrow$ no **progeny** (organisms resulting from sexual or asexual reproduction)
